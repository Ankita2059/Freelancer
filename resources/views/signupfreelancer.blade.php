...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/signupfreelancer.css') }}">
...
<body>
    <header>
        ...
        <div class="left-side">
            <span>Looking for freelancer?</span>
            <span class="apply_as_talent">Apply as client</span>
        </div>
    </header>
    <main>
        <div class="form">
            <h1>Sign up to get employment</h1>
            <div class="button">
            ...
            <div class="checkbox">
                ...
                <label for="Alert">Send me an email with tips on how to find job that fits my needs.</label>
